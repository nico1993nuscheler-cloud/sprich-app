...
enum TextInserter {
    ...
    static func insert(_ text: String) async {
        ...
        // 2. Set our text on the clipboard, marked with the nspasteboard.org
        //    conventions for "transient / not history-worthy" content.
        //    Maccy, Paste, Raycast Clipboard, Alfred, and Pastebot all
        //    respect these hints (when the user hasn't disabled the
        //    setting): dictated text won't pollute their history.
        //    Apps that don't follow the convention still capture the
        //    entry — that's a limitation of any paste-based dictation tool.
